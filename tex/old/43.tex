...
\begin{document}
	\addcontentsline{toc}{section}{4.3 - Maxima and Minima}
	...
	\fancyfoot[RO,LE]{\large Chapter 4.3}
...
\section*{Maxima and Minima}\label{cs43}
	...
	\subsubsection*{Definitions}
		...
		\begin{defn}[Local Max/Min]
			The number \(f(c)\) is a \textbf{local maximum} value of \(f\) if \blank{2.5}.  \(f(c)\)\\[15pt] is a \textbf{local minimum} value of \(f\) if \blank{3}.
		\end{defn}
		...
		\begin{ex}
			...
			\includegraphics[scale = .75]{4.3fig1}
		\end{ex}
			\newpage		
