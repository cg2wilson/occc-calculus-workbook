...
\begin{document}
	\addcontentsline{toc}{section}{3.5 - Derivatives of Trigonometric Functions}
	...
	\fancyfoot[RO,LE]{\large Chapter 3.5}
	...
	\subsubsection*{Trig Derivatives}
			\begin{center}
				...
				\begin{tabu}{| X[c] | X[c] | X[c] | X[c] |} \hline
					\multicolumn{4}{|c|}{\textbf{\large Derivatives of Trigonometric Functions}} \\ \hline
						&&& \\
